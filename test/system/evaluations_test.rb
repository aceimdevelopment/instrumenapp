...
class EvaluationsTest < ApplicationSystemTestCase
  ...
  test "creating a Evaluation" do
    ...
    fill_in "End", with: @evaluation.end
    fill_in "Lenguage", with: @evaluation.lenguage_id
    fill_in "Location", with: @evaluation.location
    fill_in "Start", with: @evaluation.start
